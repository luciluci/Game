...
class ButtonBase(pygame.sprite.Sprite):
    ...
    def __init__(self, sprite_sheet_data, sprite_sheet_data_hover):
        pygame.sprite.Sprite.__init__(self)
        sprite_sheet = SpriteSheet("resources/Menu_Items.png")

        self.image_out = sprite_sheet.get_image(sprite_sheet_data[0],
                                           sprite_sheet_data[1],
                                           sprite_sheet_data[2],
                                           sprite_sheet_data[3])

        self.image_hover = sprite_sheet.get_image(sprite_sheet_data_hover[0],
                                                  sprite_sheet_data_hover[1],
                                                  sprite_sheet_data_hover[2],
                                                  sprite_sheet_data_hover[3])
